...
//            mTypedArray.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        Log.e("=======", "onDraw: " + (System.currentTimeMillis() - timeMillis));
        //计算圆的半径
...
//                }, new float[]{0.0f, 0.6f, 0.99f, 0.998f, 1f});
        mSweepColor = Color.BLUE;
        SweepGradient sweepGradient = new SweepGradient(cx, cy,
                changeAlpha(mSweepColor, 0), changeAlpha(mSweepColor, 255));
    ...
    private static class Raindrop {
        ...
        public int changeAlpha() {
            return RadarView2.changeAlpha(color, (int) alpha);
        }
